...
if [ -z "$VOLD" ] || [ -z "$VNEW" ]; then
    ...
    python menu_tools/utils/compare_menus.py --vOld $VOLD --vNew $VNEW --menu v45_Step1p5Menu --output-dir $OUTDIR  |& tee complogs/${VNEW}vs${VOLD}/${VNEW}vs${VOLD}_step1p5.log 
