...
plots = {
    ...
    1 : ['trackerJet', 'puppiPhase1Jet', 'seededConePuppiJet'],
    #9 : ['trackerJet', 'puppiPhase1Jet', 'seededConePuppiJet'],
    2 : ['puppiPhase1JetExt', 'seededConePuppiJetExt'],
    10 : ['puppiPhase1JetExt', 'seededConePuppiJetExt'],
    3 : ['puppiPhase1HT', 'trackerHT', 'seededConePuppiHT'],
    ...
    14: ['NNPuppiTauLoose','NNPuppiTauLooseBarrel','NNPuppiTauLooseEndcap'],
    15: ['CaloTau','CaloTauBarrel','CaloTauEndcap','NNPuppiTauLoose','NNPuppiTauLooseBarrel','NNPuppiTauLooseEndcap'],
...
labels = {
    ...
    'seededConePuppiJet_Barrel': 'seeded cone puppi jet, barrel',
    'seededConePuppiJet_Endcap': 'seeded cone puppi jet, endcap',
    'caloJetExt' : 'calo jet (|#eta|<5)',
    'puppiPhase1JetExt' : 'histogr. puppi jet (|#eta|<5)',
    'puppiPhase1Jet_Barrel': 'histogr. puppi jet, barrel',
    'puppiPhase1Jet_Endcap': 'histogr. puppi jet, endcap',
    'seededConePuppiJetExt' : 'seeded cone puppi jet (|#eta|<5)',
    'puppiPhase1HT' : 'histogr. puppi jets H_{T}',
    'trackerHT' : 'tracker H_{T}',
    'caloHT' : 'calo H_{T}',
    'seededConePuppiHT' : 'seeded cone H_{T}',
    ...
    'NNPuppiTauLoose' : 'nnPuppi tau',
    'NNPuppiTauLooseBarrel' : 'nnPuppi tau, barrel',
    'NNPuppiTauLooseEndcap' : 'nnPuppi tau, endcap',
